      ...
      <div class="hidden md:flex items-center space-x-4">
        ...
        {#if auth.isAuthenticated}
          <div class="relative group">
            ...
            <!-- Dropdown -->
            <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
