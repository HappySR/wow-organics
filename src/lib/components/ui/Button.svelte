<script lang="ts">
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-primary-400 to-primary-600 text-gray-900 hover:from-primary-500 hover:to-primary-700 focus:ring-primary-500 shadow-md hover:shadow-lg',
